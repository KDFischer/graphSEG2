...
This is a fork from [tonianr/graphSEG2](https://github.com/tonianr/graphSEG2) with some internal changes to make the interactive picker work in python notebooks which can be run in Jupyter-Lab or e.g. [https://mybinder.org](mybinder.org).
